...
namespace Tangram.Blink
{
    ...
    {
        [DllImport("blink.dll", EntryPoint = "wkeIsInitialize", CallingConvention = CallingConvention.Cdecl)]
        public static extern byte wkeIsInitialize();

        [DllImport("blink.dll", EntryPoint = "wkeInitialize", CallingConvention = CallingConvention.Cdecl)]
        public static extern void wkeInitialize();

        [DllImport("blink.dll", EntryPoint = "wkeInitializeEx", CallingConvention = CallingConvention.Cdecl)]
        public static extern void wkeInitializeEx(wkeSettings settings);

        [DllImport("blink.dll", EntryPoint = "wkeFinalize", CallingConvention = CallingConvention.Cdecl)]
        public static extern void wkeFinalize();

        [DllImport("blink.dll", EntryPoint = "wkeSetViewSettings", CallingConvention = CallingConvention.Cdecl)]
        public static extern void wkeSetViewSettings(IntPtr webView, wkeViewSettings settings);

        [DllImport("blink.dll", EntryPoint = "wkeConfigure", CallingConvention = CallingConvention.Cdecl)]
        public static extern void wkeConfigure(wkeSettings settings);

        [DllImport("blink.dll", EntryPoint = "wkeSetDebugConfig", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void wkeSetDebugConfig(IntPtr webView, string debugString, [MarshalAs(UnmanagedType.LPArray)]byte[] param);

        [DllImport("blink.dll", EntryPoint = "wkeGetDebugConfig", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern IntPtr wkeGetDebugConfig(IntPtr webView, string debugString);

        [DllImport("blink.dll", EntryPoint = "wkeGetVersion", CallingConvention = CallingConvention.Cdecl)]
        public static extern uint wkeGetVersion();

        [DllImport("blink.dll", EntryPoint = "wkeGetVersionString", CallingConvention = CallingConvention.Cdecl)]
        public static extern IntPtr wkeGetVersionString();

        [DllImport("blink.dll", EntryPoint = "wkeGC", CallingConvention = CallingConvention.Cdecl)]
        public static extern void wkeGC(IntPtr webView, int delayMs);

        [DllImport("blink.dll", EntryPoint = "wkeCreateWebView", CallingConvention = CallingConvention.Cdecl)]
        public static extern IntPtr wkeCreateWebView();

        [DllImport("blink.dll", EntryPoint = "wkeGetWebView", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern IntPtr wkeGetWebView(string name);

        [DllImport("blink.dll", EntryPoint = "wkeDestroyWebView", CallingConvention = CallingConvention.Cdecl)]
        public static extern void wkeDestroyWebView(IntPtr webView);

        [DllImport("blink.dll", EntryPoint = "wkeSetMemoryCacheEnable", CallingConvention = CallingConvention.Cdecl)]
        public static extern void wkeSetMemoryCacheEnable(IntPtr webView, [MarshalAs(UnmanagedType.I1)]bool b);

        [DllImport("blink.dll", EntryPoint = "wkeSetTouchEnabled", CallingConvention = CallingConvention.Cdecl)]
        public static extern void wkeSetTouchEnabled(IntPtr webView, [MarshalAs(UnmanagedType.I1)]bool b);

        [DllImport("blink.dll", EntryPoint = "wkeSetNavigationToNewWindowEnable", CallingConvention = CallingConvention.Cdecl)]
        public static extern void wkeSetNavigationToNewWindowEnable(IntPtr webView, [MarshalAs(UnmanagedType.I1)]bool b);

        [DllImport("blink.dll", EntryPoint = "wkeSetCspCheckEnable", CallingConvention = CallingConvention.Cdecl)]
        public static extern void wkeSetCspCheckEnable(IntPtr webView, [MarshalAs(UnmanagedType.I1)]bool b);

        [DllImport("blink.dll", EntryPoint = "wkeSetNpapiPluginsEnabled", CallingConvention = CallingConvention.Cdecl)]
        public static extern void wkeSetNpapiPluginsEnabled(IntPtr webView, [MarshalAs(UnmanagedType.I1)]bool b);

        [DllImport("blink.dll", EntryPoint = "wkeSetHeadlessEnabled", CallingConvention = CallingConvention.Cdecl)]
        public static extern void wkeSetHeadlessEnabled(IntPtr webView, [MarshalAs(UnmanagedType.I1)]bool b);

        [DllImport("blink.dll", EntryPoint = "wkeSetDragEnable", CallingConvention = CallingConvention.Cdecl)]
        public static extern void wkeSetDragEnable(IntPtr webView, [MarshalAs(UnmanagedType.I1)]bool b);

        [DllImport("blink.dll", EntryPoint = "wkeSetDragDropEnable", CallingConvention = CallingConvention.Cdecl)]
        public static extern void wkeSetDragDropEnable(IntPtr WebView, [MarshalAs(UnmanagedType.I1)]bool b);

        [DllImport("blink.dll", EntryPoint = "wkeSetContextMenuItemShow", CallingConvention = CallingConvention.Cdecl)]
        public static extern void wkeSetContextMenuItemShow(IntPtr WebView, wkeMenuItemId item , [MarshalAs(UnmanagedType.I1)]bool b);

        [DllImport("blink.dll", EntryPoint = "wkeSetLanguage", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void wkeSetLanguage(IntPtr WebView, string language);

        [DllImport("blink.dll", EntryPoint = "wkeSetViewNetInterface", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern IntPtr wkeSetViewNetInterface(IntPtr webView, string netInterface);

        [DllImport("blink.dll", EntryPoint = "wkeSetProxy", CallingConvention = CallingConvention.Cdecl)]
        public static extern void wkeSetProxy(ref wkeProxy proxy);

        [DllImport("blink.dll", EntryPoint = "wkeSetViewProxy", CallingConvention = CallingConvention.Cdecl)]
        public static extern void wkeSetViewProxy(IntPtr webView, ref wkeProxy proxy);

        [DllImport("blink.dll", EntryPoint = "wkeGetName", CallingConvention = CallingConvention.Cdecl)]
        public static extern IntPtr wkeGetName(IntPtr webView);

        [DllImport("blink.dll", EntryPoint = "wkeSetName", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void wkeSetName(IntPtr webView,string name);

        [DllImport("blink.dll", EntryPoint = "wkeSetHandle", CallingConvention = CallingConvention.Cdecl)]
        public static extern void wkeSetHandle(IntPtr webView, IntPtr wndHandle);

        [DllImport("blink.dll", EntryPoint = "wkeSetHandleOffset", CallingConvention = CallingConvention.Cdecl)]
        public static extern void wkeSetHandleOffset(IntPtr webView, int x, int y);

        [DllImport("blink.dll", EntryPoint = "wkeIsTransparent", CallingConvention = CallingConvention.Cdecl)]
        public static extern byte wkeIsTransparent(IntPtr webView);

        [DllImport("blink.dll", EntryPoint = "wkeSetTransparent", CallingConvention = CallingConvention.Cdecl)]
        public static extern void wkeSetTransparent(IntPtr webView, [MarshalAs(UnmanagedType.I1)]bool transparent);

        [DllImport("blink.dll", EntryPoint = "wkeSetUserAgentW", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Unicode)]
        public static extern void wkeSetUserAgentW(IntPtr webView, string userAgent);

        [DllImport("blink.dll", EntryPoint = "wkeLoadW", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Unicode)]
        public static extern void wkeLoadW(IntPtr webView, string url);

        [DllImport("blink.dll", EntryPoint = "wkeLoadURLW", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Unicode)]
        public static extern void wkeLoadURLW(IntPtr webView, string url);

        [DllImport("blink.dll", EntryPoint = "wkePostURLW", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Unicode)]
        ...
        [DllImport("blink.dll", EntryPoint = "wkeLoadHTMLW", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Unicode)]
        public static extern void wkeLoadHTMLW(IntPtr webView, string html);

        [DllImport("blink.dll", EntryPoint = "wkeLoadFileW", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Unicode)]
        public static extern void wkeLoadFileW(IntPtr webView, string fileName);

        [DllImport("blink.dll", EntryPoint = "wkeGetURL", CallingConvention = CallingConvention.Cdecl)]
        public static extern IntPtr wkeGetURL(IntPtr webView);

        [DllImport("blink.dll", EntryPoint = "wkeIsLoading", CallingConvention = CallingConvention.Cdecl)]
        public static extern byte wkeIsLoading(IntPtr webView);

        [DllImport("blink.dll", EntryPoint = "wkeIsLoadingSucceeded", CallingConvention = CallingConvention.Cdecl)]
        public static extern byte wkeIsLoadingSucceeded(IntPtr webView);

        [DllImport("blink.dll", EntryPoint = "wkeIsLoadingFailed", CallingConvention = CallingConvention.Cdecl)]
        public static extern byte wkeIsLoadingFailed(IntPtr webView);

        [DllImport("blink.dll", EntryPoint = "wkeIsLoadingCompleted", CallingConvention = CallingConvention.Cdecl)]
        public static extern byte wkeIsLoadingCompleted(IntPtr webView);

        [DllImport("blink.dll", EntryPoint = "wkeIsDocumentReady", CallingConvention = CallingConvention.Cdecl)]
        public static extern byte wkeIsDocumentReady(IntPtr webView);

        [DllImport("blink.dll", EntryPoint = "wkeStopLoading", CallingConvention = CallingConvention.Cdecl)]
        public static extern void wkeStopLoading(IntPtr webView);

        [DllImport("blink.dll", EntryPoint = "wkeReload", CallingConvention = CallingConvention.Cdecl)]
        public static extern void wkeReload(IntPtr webView);

        [DllImport("blink.dll", EntryPoint = "wkeGoToOffset", CallingConvention = CallingConvention.Cdecl)]
        public static extern void wkeGoToOffset(IntPtr webView, int offset);

        [DllImport("blink.dll", EntryPoint = "wkeGoToIndex", CallingConvention = CallingConvention.Cdecl)]
        public static extern void wkeGoToIndex(IntPtr webView, int index);

        [DllImport("blink.dll", EntryPoint = "wkeGetWebviewId", CallingConvention = CallingConvention.Cdecl)]
        public static extern int wkeGetWebviewId(IntPtr webView);

        [DllImport("blink.dll", EntryPoint = "wkeIsWebviewAlive", CallingConvention = CallingConvention.Cdecl)]
        public static extern byte wkeIsWebviewAlive(IntPtr webView, int id);

        [DllImport("blink.dll", EntryPoint = "wkeGetDocumentCompleteURL", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("blink.dll", EntryPoint = "wkeCreateMemBuf", CallingConvention = CallingConvention.Cdecl)]
        public static extern IntPtr wkeCreateMemBuf(IntPtr webView, [MarshalAs(UnmanagedType.LPArray)]byte[] buff, int length);

        [DllImport("blink.dll", EntryPoint = "wkeFreeMemBuf", CallingConvention = CallingConvention.Cdecl)]
        public static extern void wkeFreeMemBuf(IntPtr buf);

        [DllImport("blink.dll", EntryPoint = "wkeGetTitleW", CallingConvention = CallingConvention.Cdecl)]
        public static extern IntPtr wkeGetTitleW(IntPtr webView);


        [DllImport("blink.dll", EntryPoint = "wkeResize", CallingConvention = CallingConvention.Cdecl)]
        public static extern void wkeResize(IntPtr webView, int w, int h);

        [DllImport("blink.dll", EntryPoint = "wkeGetWidth", CallingConvention = CallingConvention.Cdecl)]
        public static extern int wkeGetWidth(IntPtr webView);

        [DllImport("blink.dll", EntryPoint = "wkeGetHeight", CallingConvention = CallingConvention.Cdecl)]
        public static extern int wkeGetHeight(IntPtr webView);

        [DllImport("blink.dll", EntryPoint = "wkeGetContentWidth", CallingConvention = CallingConvention.Cdecl)]
        public static extern int wkeGetContentWidth(IntPtr webView);

        [DllImport("blink.dll", EntryPoint = "wkeGetContentHeight", CallingConvention = CallingConvention.Cdecl)]
        public static extern int wkeGetContentHeight(IntPtr webView);

        [DllImport("blink.dll", EntryPoint = "wkeSetDirty", CallingConvention = CallingConvention.Cdecl)]
        public static extern void wkeSetDirty(IntPtr webView, [MarshalAs(UnmanagedType.I1)]bool b);

        [DllImport("blink.dll", EntryPoint = "wkeIsDirty", CallingConvention = CallingConvention.Cdecl)]
        public static extern byte wkeIsDirty(IntPtr webView);

        [DllImport("blink.dll", EntryPoint = "wkeAddDirtyArea", CallingConvention = CallingConvention.Cdecl)]
        public static extern void wkeAddDirtyArea(IntPtr webView, int x, int y, int w, int h);

        [DllImport("blink.dll", EntryPoint = "wkeLayoutIfNeeded", CallingConvention = CallingConvention.Cdecl)]
        public static extern void wkeLayoutIfNeeded(IntPtr webView);

        [DllImport("blink.dll", EntryPoint = "wkePaint2", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("blink.dll", EntryPoint = "wkePaint", CallingConvention = CallingConvention.Cdecl)]
        public static extern void wkePaint(IntPtr webView, IntPtr bits, int pitch);

        [DllImport("blink.dll", EntryPoint = "wkeRepaintIfNeeded", CallingConvention = CallingConvention.Cdecl)]
        public static extern void wkeRepaintIfNeeded(IntPtr webView);

        [DllImport("blink.dll", EntryPoint = "wkeGetViewDC", CallingConvention = CallingConvention.Cdecl)]
        public static extern IntPtr wkeGetViewDC(IntPtr webView);

        [DllImport("blink.dll", EntryPoint = "wkeGetHostHWND", CallingConvention = CallingConvention.Cdecl)]
        public static extern IntPtr wkeGetHostHWND(IntPtr webView);

        [DllImport("blink.dll", EntryPoint = "wkeCanGoBack", CallingConvention = CallingConvention.Cdecl)]
        public static extern byte wkeCanGoBack(IntPtr webView);

        [DllImport("blink.dll", EntryPoint = "wkeGoBack", CallingConvention = CallingConvention.Cdecl)]
        public static extern byte wkeGoBack(IntPtr webView);

        [DllImport("blink.dll", EntryPoint = "wkeCanGoForward", CallingConvention = CallingConvention.Cdecl)]
        public static extern byte wkeCanGoForward(IntPtr webView);

        [DllImport("blink.dll", EntryPoint = "wkeGoForward", CallingConvention = CallingConvention.Cdecl)]
        public static extern byte wkeGoForward(IntPtr webView);

        [DllImport("blink.dll", EntryPoint = "wkeEditorSelectAll", CallingConvention = CallingConvention.Cdecl)]
        public static extern byte wkeEditorSelectAll(IntPtr webView);

        [DllImport("blink.dll", EntryPoint = "wkeEditorUnSelect", CallingConvention = CallingConvention.Cdecl)]
        public static extern byte wkeEditorUnSelect(IntPtr webView);

        [DllImport("blink.dll", EntryPoint = "wkeEditorCopy", CallingConvention = CallingConvention.Cdecl)]
        public static extern void wkeEditorCopy(IntPtr webView);

        [DllImport("blink.dll", EntryPoint = "wkeEditorCut", CallingConvention = CallingConvention.Cdecl)]
        public static extern void wkeEditorCut(IntPtr webView);

        [DllImport("blink.dll", EntryPoint = "wkeEditorPaste", CallingConvention = CallingConvention.Cdecl)]
        public static extern void wkeEditorPaste(IntPtr webView);

        [DllImport("blink.dll", EntryPoint = "wkeEditorDelete", CallingConvention = CallingConvention.Cdecl)]
        public static extern void wkeEditorDelete(IntPtr webView);

        [DllImport("blink.dll", EntryPoint = "wkeEditorUndo", CallingConvention = CallingConvention.Cdecl)]
        public static extern void wkeEditorUndo(IntPtr webView);

        [DllImport("blink.dll", EntryPoint = "wkeEditorRedo", CallingConvention = CallingConvention.Cdecl)]
        public static extern void wkeEditorRedo(IntPtr webView);

        [DllImport("blink.dll", EntryPoint = "wkeGetCookieW", CallingConvention = CallingConvention.Cdecl)]
        public static extern IntPtr wkeGetCookieW(IntPtr webView);

        [DllImport("blink.dll", EntryPoint = "wkeSetCookie", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("blink.dll", EntryPoint = "wkeVisitAllCookie", CallingConvention = CallingConvention.Cdecl)]
        public static extern void wkeVisitAllCookie(IntPtr webView, IntPtr usetData, wkeCookieVisitor visitor);

        [DllImport("blink.dll", EntryPoint = "wkePerformCookieCommand", CallingConvention = CallingConvention.Cdecl)]
        public static extern void wkePerformCookieCommand(wkeCookieCommand command);

        [DllImport("blink.dll", EntryPoint = "wkeSetCookieEnabled", CallingConvention = CallingConvention.Cdecl)]
        public static extern void wkeSetCookieEnabled(IntPtr webView, [MarshalAs(UnmanagedType.I1)]bool enable);

        [DllImport("blink.dll", EntryPoint = "wkeIsCookieEnabled", CallingConvention = CallingConvention.Cdecl)]
        public static extern byte wkeIsCookieEnabled(IntPtr webView);

        [DllImport("blink.dll", EntryPoint = "wkeSetCookieJarPath", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Unicode)]
        public static extern void wkeSetCookieJarPath(IntPtr webView, string path);

        [DllImport("blink.dll", EntryPoint = "wkeSetCookieJarFullPath", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Unicode)]
        public static extern void wkeSetCookieJarFullPath(IntPtr webView, string path);

        [DllImport("blink.dll", EntryPoint = "wkeSetLocalStorageFullPath", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Unicode)]
        public static extern void wkeSetLocalStorageFullPath(IntPtr webView, string path);

        [DllImport("blink.dll", EntryPoint = "wkeSetMediaVolume", CallingConvention = CallingConvention.Cdecl)]
        public static extern void wkeSetMediaVolume(IntPtr webView, float volume);

        [DllImport("blink.dll", EntryPoint = "wkeGetMediaVolume", CallingConvention = CallingConvention.Cdecl)]
        public static extern float wkeGetMediaVolume(IntPtr webView);

        [DllImport("blink.dll", EntryPoint = "wkeFireMouseEvent", CallingConvention = CallingConvention.Cdecl)]
        public static extern byte wkeFireMouseEvent(IntPtr webView, uint message, int x, int y, uint flags);

        [DllImport("blink.dll", EntryPoint = "wkeFireContextMenuEvent", CallingConvention = CallingConvention.Cdecl)]
        public static extern byte wkeFireContextMenuEvent(IntPtr webView, int x, int y, uint flags);

        [DllImport("blink.dll", EntryPoint = "wkeFireMouseWheelEvent", CallingConvention = CallingConvention.Cdecl)]
        public static extern byte wkeFireMouseWheelEvent(IntPtr webView, int x, int y, int delta, uint flags);

        [DllImport("blink.dll", EntryPoint = "wkeFireKeyUpEvent", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("blink.dll", EntryPoint = "wkeFireKeyDownEvent", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("blink.dll", EntryPoint = "wkeFireKeyPressEvent", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("blink.dll", EntryPoint = "wkeFireWindowsMessage", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("blink.dll", EntryPoint = "wkeSetFocus", CallingConvention = CallingConvention.Cdecl)]
        public static extern byte wkeSetFocus(IntPtr webView);

        [DllImport("blink.dll", EntryPoint = "wkeKillFocus", CallingConvention = CallingConvention.Cdecl)]
        public static extern byte wkeKillFocus(IntPtr webView);

        [DllImport("blink.dll", EntryPoint = "wkeGetCaretRect", CallingConvention = CallingConvention.Cdecl)]
        public static extern wkeRect wkeGetCaretRect(IntPtr webView);

        [DllImport("blink.dll", EntryPoint = "wkeRunJSW", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Unicode)]
        public static extern Int64 wkeRunJSW(IntPtr webView, string script);

        [DllImport("blink.dll", EntryPoint = "wkeGlobalExec", CallingConvention = CallingConvention.Cdecl)]
        public static extern IntPtr wkeGlobalExec(IntPtr webView);

        [DllImport("blink.dll", EntryPoint = "wkeSleep", CallingConvention = CallingConvention.Cdecl)]
        public static extern void wkeSleep(IntPtr webView);

        [DllImport("blink.dll", EntryPoint = "wkeWake", CallingConvention = CallingConvention.Cdecl)]
        public static extern void wkeWake(IntPtr webView);

        [DllImport("blink.dll", EntryPoint = "wkeIsAwake", CallingConvention = CallingConvention.Cdecl)]
        public static extern byte wkeIsAwake(IntPtr webView);

        [DllImport("blink.dll", EntryPoint = "wkeSetZoomFactor", CallingConvention = CallingConvention.Cdecl)]
        public static extern void wkeSetZoomFactor(IntPtr webView, float factor);

        [DllImport("blink.dll", EntryPoint = "wkeGetZoomFactor", CallingConvention = CallingConvention.Cdecl)]
        public static extern float wkeGetZoomFactor(IntPtr webView);

        [DllImport("blink.dll", EntryPoint = "wkeSetEditable", CallingConvention = CallingConvention.Cdecl)]
        public static extern void wkeSetEditable(IntPtr webView, [MarshalAs(UnmanagedType.I1)]bool editable);

        [DllImport("blink.dll", EntryPoint = "wkeGetStringW", CallingConvention = CallingConvention.Cdecl)]
        public static extern IntPtr wkeGetStringW(IntPtr wkeString);

        [DllImport("blink.dll", EntryPoint = "wkeSetStringW", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Unicode)]
        public static extern void wkeSetStringW(IntPtr wkeString, string str, int len);

        [DllImport("blink.dll", EntryPoint = "wkeCreateStringW", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Unicode)]
        public static extern IntPtr wkeCreateStringW(string str, int len);

        [DllImport("blink.dll", EntryPoint = "wkeDeleteString", CallingConvention = CallingConvention.Cdecl)]
        public static extern void wkeDeleteString(IntPtr wkeString);

        [DllImport("blink.dll", EntryPoint = "wkeGetWebViewForCurrentContext", CallingConvention = CallingConvention.Cdecl)]
        public static extern IntPtr wkeGetWebViewForCurrentContext();

        [DllImport("blink.dll", EntryPoint = "wkeSetUserKeyValue", CallingConvention = CallingConvention.Cdecl,CharSet = CharSet.Ansi)]
        public static extern void wkeSetUserKeyValue(IntPtr webView, string key, IntPtr value);

        [DllImport("blink.dll", EntryPoint = "wkeGetUserKeyValue", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern IntPtr wkeGetUserKeyValue(IntPtr webView, string key);

        [DllImport("blink.dll", EntryPoint = "wkeGetCursorInfoType", CallingConvention = CallingConvention.Cdecl)]
        public static extern wkeCursorInfo wkeGetCursorInfoType(IntPtr webView);

        [DllImport("blink.dll", EntryPoint = "wkeSetCursorInfoType", CallingConvention = CallingConvention.Cdecl)]
        public static extern void wkeSetCursorInfoType(IntPtr webView, wkeCursorInfo type);

        [DllImport("blink.dll", EntryPoint = "wkeSetDragFiles", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("blink.dll", EntryPoint = "wkeOnMouseOverUrlChanged", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("blink.dll", EntryPoint = "wkeOnWillReleaseScriptContext", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("blink.dll", EntryPoint = "wkeNetOnResponse", CallingConvention = CallingConvention.Cdecl)]
        public static extern void wkeNetOnResponse(IntPtr webView, wkeNetResponseCallback callback, IntPtr callbackParam);

        [DllImport("blink.dll", EntryPoint = "wkeNetSetMIMEType", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void wkeNetSetMIMEType(IntPtr job, string type);

        [DllImport("blink.dll", EntryPoint = "wkeNetSetHTTPHeaderField", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Unicode)]
        ...
        [DllImport("blink.dll", EntryPoint = "wkeNetSetURL", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void wkeNetSetURL(IntPtr job, string url);

        [DllImport("blink.dll", EntryPoint = "wkeNetSetData", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        [DllImport("blink.dll", EntryPoint = "wkeNetHookRequest", CallingConvention = CallingConvention.Cdecl)]
        public static extern void wkeNetHookRequest(IntPtr job);

        [DllImport("blink.dll", EntryPoint = "wkeNetGetMIMEType", CallingConvention = CallingConvention.Cdecl)]
        public static extern void wkeNetGetMIMEType(IntPtr job, IntPtr mime);


        [DllImport("blink.dll", EntryPoint = "wkeIsMainFrame", CallingConvention = CallingConvention.Cdecl)]
        public static extern byte wkeIsMainFrame(IntPtr webFrame);

        [DllImport("blink.dll", EntryPoint = "wkeIsWebRemoteFrame", CallingConvention = CallingConvention.Cdecl)]
        public static extern byte wkeIsWebRemoteFrame(IntPtr webFrame);

        [DllImport("blink.dll", EntryPoint = "wkeWebFrameGetMainFrame", CallingConvention = CallingConvention.Cdecl)]
        public static extern IntPtr wkeWebFrameGetMainFrame(IntPtr webView);

        [DllImport("blink.dll", EntryPoint = "wkeWebFrameGetMainWorldScriptContext", CallingConvention = CallingConvention.Cdecl)]
        public static extern void wkeWebFrameGetMainWorldScriptContext(IntPtr webFrame, ref IntPtr contextOut);

        [DllImport("blink.dll", EntryPoint = "wkeGetBlinkMainThreadIsolate", CallingConvention = CallingConvention.Cdecl)]
        public static extern IntPtr wkeGetBlinkMainThreadIsolate();

        [DllImport("blink.dll", EntryPoint = "wkeRunJsByFrame", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("blink.dll", EntryPoint = "wkeSetFileSystem", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("blink.dll", EntryPoint = "wkeGetWindowHandle", CallingConvention = CallingConvention.Cdecl)]
        public static extern IntPtr wkeGetWindowHandle(IntPtr WebView);

        [DllImport("blink.dll", EntryPoint = "wkeOnWillMediaLoad", CallingConvention = CallingConvention.Cdecl)]
        public static extern void wkeOnWillMediaLoad(IntPtr WebView, wkeWillMediaLoadCallback callback, IntPtr param);

        [DllImport("blink.dll", EntryPoint = "wkeDeleteWillSendRequestInfo", CallingConvention = CallingConvention.Cdecl)]
        public static extern void wkeDeleteWillSendRequestInfo(IntPtr WebView, IntPtr info);

        [DllImport("blink.dll", EntryPoint = "wkeOnOtherLoad", CallingConvention = CallingConvention.Cdecl)]
        public static extern void wkeOnOtherLoad(IntPtr WebView, wkeOnOtherLoadCallback callback, IntPtr param);

        [DllImport("blink.dll", EntryPoint = "wkeSetDeviceParameter", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("blink.dll", EntryPoint = "wkeAddPluginDirectory", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Unicode)]
        public static extern void wkeAddPluginDirectory(IntPtr WebView, string path);

        [DllImport("blink.dll", EntryPoint = "wkeGetGlobalExecByFrame", CallingConvention = CallingConvention.Cdecl)]
        public static extern IntPtr wkeGetGlobalExecByFrame(IntPtr WebView, IntPtr frameId);

        [DllImport("blink.dll", EntryPoint = "wkeShowDevtools", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Unicode)]
        public static extern void wkeShowDevtools(IntPtr WebView, string path, wkeOnShowDevtoolsCallback callback, IntPtr param);

        [DllImport("blink.dll", EntryPoint = "wkeInsertCSSByFrame", CallingConvention = CallingConvention.Cdecl)]
        public static extern void wkeInsertCSSByFrame(IntPtr WebView, IntPtr frameId, [MarshalAs(UnmanagedType.LPArray)]byte[] utf8css);

        [DllImport("blink.dll", EntryPoint = "wkeSetResourceGc", CallingConvention = CallingConvention.Cdecl)]
        public static extern void wkeSetResourceGc(IntPtr WebView, int intervalSec);

        [DllImport("blink.dll", EntryPoint = "wkeLoadHtmlWithBaseUrl", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("blink.dll", EntryPoint = "wkeGetUserAgent", CallingConvention = CallingConvention.Cdecl)]
        public static extern IntPtr wkeGetUserAgent(IntPtr webView);

        [DllImport("blink.dll", EntryPoint = "wkeGetFrameUrl", CallingConvention = CallingConvention.Cdecl)]
        public static extern IntPtr wkeGetFrameUrl(IntPtr webView, IntPtr frameId);

        [DllImport("blink.dll", EntryPoint = "wkeNetGetFavicon", CallingConvention = CallingConvention.Cdecl)]
        public static extern int wkeNetGetFavicon(IntPtr webView, wkeNetResponseCallback callback, IntPtr param);

        [DllImport("blink.dll", EntryPoint = "wkeIsProcessingUserGesture", CallingConvention = CallingConvention.Cdecl)]
        public static extern byte wkeIsProcessingUserGesture(IntPtr webView);

        [DllImport("blink.dll", EntryPoint = "wkeUtilSerializeToMHTML", CallingConvention = CallingConvention.Cdecl)]
        public static extern IntPtr wkeUtilSerializeToMHTML(IntPtr webView);

        [DllImport("blink.dll", EntryPoint = "wkeGetSource", CallingConvention = CallingConvention.Cdecl)]
        public static extern IntPtr wkeGetSource(IntPtr webView);

        //////////////////////////////////////脚本
        [DllImport("blink.dll", EntryPoint = "wkeJsBindFunction", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void wkeJsBindFunction(string name, wkeJsNativeFunction fn, IntPtr param, uint argCount);

        [DllImport("blink.dll", EntryPoint = "wkeJsBindGetter", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void wkeJsBindGetter(string name, wkeJsNativeFunction fn, IntPtr param);

        [DllImport("blink.dll", EntryPoint = "wkeJsBindSetter", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void wkeJsBindSetter(string name, wkeJsNativeFunction fn, IntPtr param);

        [DllImport("blink.dll", EntryPoint = "jsArgCount", CallingConvention = CallingConvention.Cdecl)]
        public static extern int jsArgCount(IntPtr es);

        [DllImport("blink.dll", EntryPoint = "jsArgType", CallingConvention = CallingConvention.Cdecl)]
        public static extern jsType jsArgType(IntPtr es, int argIdx);

        [DllImport("blink.dll", EntryPoint = "jsArg", CallingConvention = CallingConvention.Cdecl)]
        public static extern Int64 jsArg(IntPtr es, int argIdx);

        [DllImport("blink.dll", EntryPoint = "jsTypeOf", CallingConvention = CallingConvention.Cdecl)]
        public static extern jsType jsTypeOf(Int64 v);

        [DllImport("blink.dll", EntryPoint = "jsIsNumber", CallingConvention = CallingConvention.Cdecl)]
        public static extern byte jsIsNumber(Int64 v);

        [DllImport("blink.dll", EntryPoint = "jsIsString", CallingConvention = CallingConvention.Cdecl)]
        public static extern byte jsIsString(Int64 v);

        [DllImport("blink.dll", EntryPoint = "jsIsBoolean", CallingConvention = CallingConvention.Cdecl)]
        public static extern byte jsIsBoolean(Int64 v);

        [DllImport("blink.dll", EntryPoint = "jsIsObject", CallingConvention = CallingConvention.Cdecl)]
        public static extern byte jsIsObject(Int64 v);

        [DllImport("blink.dll", EntryPoint = "jsIsFunction", CallingConvention = CallingConvention.Cdecl)]
        public static extern byte jsIsFunction(Int64 v);

        [DllImport("blink.dll", EntryPoint = "jsIsUndefined", CallingConvention = CallingConvention.Cdecl)]
        public static extern byte jsIsUndefined(Int64 v);

        [DllImport("blink.dll", EntryPoint = "jsIsNull", CallingConvention = CallingConvention.Cdecl)]
        public static extern byte jsIsNull(Int64 v);

        [DllImport("blink.dll", EntryPoint = "jsIsArray", CallingConvention = CallingConvention.Cdecl)]
        public static extern byte jsIsArray(Int64 v);

        [DllImport("blink.dll", EntryPoint = "jsIsTrue", CallingConvention = CallingConvention.Cdecl)]
        public static extern byte jsIsTrue(Int64 v);

        [DllImport("blink.dll", EntryPoint = "jsIsFalse", CallingConvention = CallingConvention.Cdecl)]
        public static extern byte jsIsFalse(Int64 v);



        [DllImport("blink.dll", EntryPoint = "jsToInt", CallingConvention = CallingConvention.Cdecl)]
        public static extern int jsToInt(IntPtr es, Int64 v);

        [DllImport("blink.dll", EntryPoint = "jsToFloat", CallingConvention = CallingConvention.Cdecl)]
        public static extern float jsToFloat(IntPtr es, Int64 v);

        [DllImport("blink.dll", EntryPoint = "jsToDouble", CallingConvention = CallingConvention.Cdecl)]
        public static extern double jsToDouble(IntPtr es, Int64 v);

        [DllImport("blink.dll", EntryPoint = "jsToBoolean", CallingConvention = CallingConvention.Cdecl)]
        public static extern byte jsToBoolean(IntPtr es, Int64 v);

        [DllImport("blink.dll", EntryPoint = "jsToTempStringW", CallingConvention = CallingConvention.Cdecl)]
        public static extern IntPtr jsToTempStringW(IntPtr es, Int64 v);

        [DllImport("blink.dll", EntryPoint = "jsInt", CallingConvention = CallingConvention.Cdecl)]
        public static extern Int64 jsInt(int n);

        [DllImport("blink.dll", EntryPoint = "jsFloat", CallingConvention = CallingConvention.Cdecl)]
        public static extern Int64 jsFloat(float f);

        [DllImport("blink.dll", EntryPoint = "jsDouble", CallingConvention = CallingConvention.Cdecl)]
        public static extern Int64 jsDouble(double d);

        [DllImport("blink.dll", EntryPoint = "jsBoolean", CallingConvention = CallingConvention.Cdecl)]
        public static extern Int64 jsBoolean(byte b);

        [DllImport("blink.dll", EntryPoint = "jsUndefined", CallingConvention = CallingConvention.Cdecl)]
        public static extern Int64 jsUndefined();

        [DllImport("blink.dll", EntryPoint = "jsNull", CallingConvention = CallingConvention.Cdecl)]
        public static extern Int64 jsNull();

        [DllImport("blink.dll", EntryPoint = "jsTrue", CallingConvention = CallingConvention.Cdecl)]
        public static extern Int64 jsTrue();

        [DllImport("blink.dll", EntryPoint = "jsFalse", CallingConvention = CallingConvention.Cdecl)]
        public static extern Int64 jsFalse();

        [DllImport("blink.dll", EntryPoint = "jsStringW", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Unicode)]
        public static extern Int64 jsStringW(IntPtr es, string str);

        [DllImport("blink.dll", EntryPoint = "jsEmptyObject", CallingConvention = CallingConvention.Cdecl)]
        public static extern Int64 jsEmptyObject(IntPtr es);

        [DllImport("blink.dll", EntryPoint = "jsEmptyArray", CallingConvention = CallingConvention.Cdecl)]
        public static extern Int64 jsEmptyArray(IntPtr es);

        [DllImport("blink.dll", EntryPoint = "jsArrayBuffer", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern Int64 jsArrayBuffer(IntPtr es, StringBuilder buffer, int size);

        [DllImport("blink.dll", EntryPoint = "jsObject", CallingConvention = CallingConvention.Cdecl)]
        public static extern Int64 jsObject(IntPtr es, IntPtr obj);

        [DllImport("blink.dll", EntryPoint = "jsFunction", CallingConvention = CallingConvention.Cdecl)]
        public static extern Int64 jsFunction(IntPtr es, IntPtr obj);

        [DllImport("blink.dll", EntryPoint = "jsGetData", CallingConvention = CallingConvention.Cdecl)]
        public static extern IntPtr jsGetData(IntPtr es, Int64 jsValue);

        [DllImport("blink.dll", EntryPoint = "jsGet", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern Int64 jsGet(IntPtr es, Int64 jsValue, string prop);

        [DllImport("blink.dll", EntryPoint = "jsSet", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void jsSet(IntPtr es, Int64 jsValue, string prop, Int64 v);

        [DllImport("blink.dll", EntryPoint = "jsGetAt", CallingConvention = CallingConvention.Cdecl)]
        public static extern Int64 jsGetAt(IntPtr es, Int64 jsValue, int index);

        [DllImport("blink.dll", EntryPoint = "jsSetAt", CallingConvention = CallingConvention.Cdecl)]
        public static extern void jsSetAt(IntPtr es, Int64 jsValue, int index, Int64 v);

        [DllImport("blink.dll", EntryPoint = "jsGetLength", CallingConvention = CallingConvention.Cdecl)]
        public static extern int jsGetLength(IntPtr es, Int64 jsValue);

        [DllImport("blink.dll", EntryPoint = "jsSetLength", CallingConvention = CallingConvention.Cdecl)]
        public static extern void jsSetLength(IntPtr es, Int64 jsValue, int length);

        [DllImport("blink.dll", EntryPoint = "jsGlobalObject", CallingConvention = CallingConvention.Cdecl)]
        public static extern Int64 jsGlobalObject(IntPtr es);

        [DllImport("blink.dll", EntryPoint = "jsGetWebView", CallingConvention = CallingConvention.Cdecl)]
        public static extern IntPtr jsGetWebView(IntPtr es);

        [DllImport("blink.dll", EntryPoint = "jsEvalW", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Unicode)]
        public static extern Int64 jsEvalW(IntPtr es, string str);

        [DllImport("blink.dll", EntryPoint = "jsEvalExW", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Unicode)]
        public static extern Int64 jsEvalExW(IntPtr es, string str, [MarshalAs(UnmanagedType.I1)]bool isInClosure);

        [DllImport("blink.dll", EntryPoint = "jsCall", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("blink.dll", EntryPoint = "jsCallGlobal", CallingConvention = CallingConvention.Cdecl)]
        public static extern Int64 jsCallGlobal(IntPtr es, Int64 func, [MarshalAs(UnmanagedType.LPArray)]Int64[] args, int argCount);

        [DllImport("blink.dll", EntryPoint = "jsGetGlobal", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern Int64 jsGetGlobal(IntPtr es, string prop);

        [DllImport("blink.dll", EntryPoint = "jsSetGlobal", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void jsSetGlobal(IntPtr es, string prop, Int64 jsValue);

        [DllImport("blink.dll", EntryPoint = "jsGC", CallingConvention = CallingConvention.Cdecl)]
        public static extern void jsGC();

        [DllImport("blink.dll", EntryPoint = "jsIsJsValueValid", CallingConvention = CallingConvention.Cdecl)]
        public static extern byte jsIsJsValueValid(IntPtr es, Int64 jsValue);

        [DllImport("blink.dll", EntryPoint = "jsIsValidExecState", CallingConvention = CallingConvention.Cdecl)]
        public static extern byte jsIsValidExecState(IntPtr es);

        [DllImport("blink.dll", EntryPoint = "jsDeleteObjectProp", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern void jsDeleteObjectProp(IntPtr es, Int64 jsValue, string prop);

        [DllImport("blink.dll", EntryPoint = "jsGetArrayBuffer", CallingConvention = CallingConvention.Cdecl)]
        public static extern IntPtr jsGetArrayBuffer(IntPtr es, Int64 jsValue);

        [DllImport("blink.dll", EntryPoint = "jsGetLastErrorIfException", CallingConvention = CallingConvention.Cdecl)]
        public static extern IntPtr jsGetLastErrorIfException(IntPtr es);

        [DllImport("blink.dll", EntryPoint = "jsThrowException", CallingConvention = CallingConvention.Cdecl)]
        public static extern Int64 jsThrowException(IntPtr es, [MarshalAs(UnmanagedType.LPArray)]byte[] utf8exception);

        [DllImport("blink.dll", EntryPoint = "jsGetKeys", CallingConvention = CallingConvention.Cdecl)]
